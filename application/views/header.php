...
<html>
 ...
 <div id="navigation-section">
 	<div id="logo"><img height="100" width="220" src="<?php echo $this->config->item('base_url')?>assets/images/logo.jpg"/>
    </div>
 	<div id="menu">
		<ul>
        	<li><a href="<?php echo $this->config->item('base_url')?>front">Home</a></li>
            <li><a href="<?php echo $this->config->item('base_url')?>front#about-data">About</a></li>
            <li><a href="<?php echo $this->config->item('base_url')?>front#services-section">Services</a></li>
<!--
            <li><a href="">Our Work</a></li>
            <li><a href="">Carrer</a></li>
-->
            <li><a href="<?php echo $this->config->item('base_url')?>blog">Blog</a></li>
